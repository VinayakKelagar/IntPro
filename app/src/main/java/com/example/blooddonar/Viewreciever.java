...
public class Viewreciever extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.viewreciever);

        shp=new SharedPrefHandler(this);
        string_type=shp.getSharedPreferences("type");

        Toast.makeText(Viewreciever.this, "Get Value"+string_type, Toast.LENGTH_SHORT).show();
